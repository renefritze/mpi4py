...
static int
PyMPI_Get_count_c(MPI_Status *a1,
                  MPI_Datatype a2,
                  MPI_Count *a3)
{
  int ierr;
...
static int
PyMPI_Sendrecv_replace_c(void *a1,
                         MPI_Count a2,
                         MPI_Datatype a3,
                         int a4,
                         int a5,
...
static int
PyMPI_Isendrecv_replace_c(void *a1,
                          MPI_Count a2,
                          MPI_Datatype a3,
                          int a4,
                          int a5,
...
static int
PyMPI_Reduce_scatter_block_c(void *a1,
                             void *a2,
                             MPI_Count a3,
                             MPI_Datatype a4,
                             MPI_Op a5,
...
static int
PyMPI_Reduce_scatter_c(void *a1,
                       void *a2,
                       MPI_Count *a3,
                       MPI_Datatype a4,
                       MPI_Op a5,
...
static int
PyMPI_Neighbor_allgather_c(void *a1,
                           MPI_Count a2,
                           MPI_Datatype a3,
                           void *a4,
                           MPI_Count a5,
...
static int
PyMPI_Neighbor_allgatherv_c(void *a1,
                            MPI_Count a2,
                            MPI_Datatype a3,
                            void *a4,
                            MPI_Count *a5,
...
static int
PyMPI_Neighbor_alltoall_c(void *a1,
                          MPI_Count a2,
                          MPI_Datatype a3,
                          void *a4,
                          MPI_Count a5,
...
static int
PyMPI_Neighbor_alltoallv_c(void *a1,
                           MPI_Count *a2,
                           MPI_Aint *a3,
                           MPI_Datatype a4,
                           void *a5,
...
static int
PyMPI_Neighbor_alltoallw_c(void *a1,
                           MPI_Count *a2,
                           MPI_Aint *a3,
                           MPI_Datatype *a4,
                           void *a5,
...
static int
PyMPI_Ireduce_scatter_block_c(void *a1,
                              void *a2,
                              MPI_Count a3,
                              MPI_Datatype a4,
                              MPI_Op a5,
...
static int
PyMPI_Ireduce_scatter_c(void *a1,
                        void *a2,
                        MPI_Count *a3,
                        MPI_Datatype a4,
                        MPI_Op a5,
...
static int
PyMPI_Ineighbor_allgather_c(void *a1,
                            MPI_Count a2,
                            MPI_Datatype a3,
                            void *a4,
                            MPI_Count a5,
...
static int
PyMPI_Ineighbor_allgatherv_c(void *a1,
                             MPI_Count a2,
                             MPI_Datatype a3,
                             void *a4,
                             MPI_Count *a5,
...
static int
PyMPI_Ineighbor_alltoall_c(void *a1,
                           MPI_Count a2,
                           MPI_Datatype a3,
                           void *a4,
                           MPI_Count a5,
...
static int
PyMPI_Ineighbor_alltoallv_c(void *a1,
                            MPI_Count *a2,
                            MPI_Aint *a3,
                            MPI_Datatype a4,
                            void *a5,
...
static int
PyMPI_Ineighbor_alltoallw_c(void *a1,
                            MPI_Count *a2,
                            MPI_Aint *a3,
                            MPI_Datatype *a4,
                            void *a5,
...
static int
PyMPI_Allreduce_init_c(void *a1,
                       void *a2,
                       MPI_Count a3,
                       MPI_Datatype a4,
                       MPI_Op a5,
...
static int
PyMPI_Reduce_scatter_block_init_c(void *a1,
                                  void *a2,
                                  MPI_Count a3,
                                  MPI_Datatype a4,
                                  MPI_Op a5,
...
static int
PyMPI_Reduce_scatter_init_c(void *a1,
                            void *a2,
                            MPI_Count *a3,
                            MPI_Datatype a4,
                            MPI_Op a5,
...
static int
PyMPI_Win_allocate_c(MPI_Aint a1,
                     MPI_Aint a2,
                     MPI_Info a3,
                     MPI_Comm a4,
                     void *a5,
...
static int
PyMPI_Win_allocate_shared_c(MPI_Aint a1,
                            MPI_Aint a2,
                            MPI_Info a3,
                            MPI_Comm a4,
                            void *a5,
...
static int
PyMPI_Win_shared_query_c(MPI_Win a1,
                         int a2,
                         MPI_Aint *a3,
                         MPI_Aint *a4,
                         void *a5)
...
static int
PyMPI_Get_accumulate_c(void *a1,
                       MPI_Count a2,
                       MPI_Datatype a3,
                       void *a4,
                       MPI_Count a5,
...
static int
PyMPI_Rget_accumulate_c(void *a1,
                        MPI_Count a2,
                        MPI_Datatype a3,
                        void *a4,
                        MPI_Count a5,
...
static int
PyMPI_File_read_at_c(MPI_File a1,
                     MPI_Offset a2,
                     void *a3,
                     MPI_Count a4,
                     MPI_Datatype a5,
...
static int
PyMPI_File_read_at_all_c(MPI_File a1,
                         MPI_Offset a2,
                         void *a3,
                         MPI_Count a4,
                         MPI_Datatype a5,
...
static int
PyMPI_File_write_at_c(MPI_File a1,
                      MPI_Offset a2,
                      void *a3,
                      MPI_Count a4,
                      MPI_Datatype a5,
...
static int
PyMPI_File_write_at_all_c(MPI_File a1,
                          MPI_Offset a2,
                          void *a3,
                          MPI_Count a4,
                          MPI_Datatype a5,
...
static int
PyMPI_File_iread_at_c(MPI_File a1,
                      MPI_Offset a2,
                      void *a3,
                      MPI_Count a4,
                      MPI_Datatype a5,
...
static int
PyMPI_File_iread_at_all_c(MPI_File a1,
                          MPI_Offset a2,
                          void *a3,
                          MPI_Count a4,
                          MPI_Datatype a5,
...
static int
PyMPI_File_iwrite_at_c(MPI_File a1,
                       MPI_Offset a2,
                       void *a3,
                       MPI_Count a4,
                       MPI_Datatype a5,
...
static int
PyMPI_File_iwrite_at_all_c(MPI_File a1,
                           MPI_Offset a2,
                           void *a3,
                           MPI_Count a4,
                           MPI_Datatype a5,
...
static int
PyMPI_File_read_all_c(MPI_File a1,
                      void *a2,
                      MPI_Count a3,
                      MPI_Datatype a4,
                      MPI_Status *a5)
...
static int
PyMPI_File_write_c(MPI_File a1,
                   void *a2,
                   MPI_Count a3,
                   MPI_Datatype a4,
                   MPI_Status *a5)
...
static int
PyMPI_File_write_all_c(MPI_File a1,
                       void *a2,
                       MPI_Count a3,
                       MPI_Datatype a4,
                       MPI_Status *a5)
...
static int
PyMPI_File_iread_c(MPI_File a1,
                   void *a2,
                   MPI_Count a3,
                   MPI_Datatype a4,
                   MPI_Request *a5)
...
static int
PyMPI_File_iread_all_c(MPI_File a1,
                       void *a2,
                       MPI_Count a3,
                       MPI_Datatype a4,
                       MPI_Request *a5)
...
static int
PyMPI_File_iwrite_c(MPI_File a1,
                    void *a2,
                    MPI_Count a3,
                    MPI_Datatype a4,
                    MPI_Request *a5)
...
static int
PyMPI_File_iwrite_all_c(MPI_File a1,
                        void *a2,
                        MPI_Count a3,
                        MPI_Datatype a4,
                        MPI_Request *a5)
...
static int
PyMPI_File_read_shared_c(MPI_File a1,
                         void *a2,
                         MPI_Count a3,
                         MPI_Datatype a4,
                         MPI_Status *a5)
...
static int
PyMPI_File_write_shared_c(MPI_File a1,
                          void *a2,
                          MPI_Count a3,
                          MPI_Datatype a4,
                          MPI_Status *a5)
...
static int
PyMPI_File_iread_shared_c(MPI_File a1,
                          void *a2,
                          MPI_Count a3,
                          MPI_Datatype a4,
                          MPI_Request *a5)
...
static int
PyMPI_File_iwrite_shared_c(MPI_File a1,
                           void *a2,
                           MPI_Count a3,
                           MPI_Datatype a4,
                           MPI_Request *a5)
...
static int
PyMPI_File_read_ordered_c(MPI_File a1,
                          void *a2,
                          MPI_Count a3,
                          MPI_Datatype a4,
                          MPI_Status *a5)
...
static int
PyMPI_File_write_ordered_c(MPI_File a1,
                           void *a2,
                           MPI_Count a3,
                           MPI_Datatype a4,
                           MPI_Status *a5)
...
static int
PyMPI_File_read_at_all_begin_c(MPI_File a1,
                               MPI_Offset a2,
                               void *a3,
                               MPI_Count a4,
                               MPI_Datatype a5)
...
static int
PyMPI_File_write_at_all_begin_c(MPI_File a1,
                                MPI_Offset a2,
                                void *a3,
                                MPI_Count a4,
                                MPI_Datatype a5)
...
static int
PyMPI_File_read_all_begin_c(MPI_File a1,
                            void *a2,
                            MPI_Count a3,
                            MPI_Datatype a4)
{
...
static int
PyMPI_File_write_all_begin_c(MPI_File a1,
                             void *a2,
                             MPI_Count a3,
                             MPI_Datatype a4)
{
...
static int
PyMPI_File_read_ordered_begin_c(MPI_File a1,
                                void *a2,
                                MPI_Count a3,
                                MPI_Datatype a4)
{
...
static int
PyMPI_File_write_ordered_begin_c(MPI_File a1,
                                 void *a2,
                                 MPI_Count a3,
                                 MPI_Datatype a4)
{
...
static int
PyMPI_File_get_type_extent_c(MPI_File a1,
                             MPI_Datatype a2,
                             MPI_Count *a3)
{
  int ierr;
