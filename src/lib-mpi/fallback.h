...
static int
PyMPI_Info_get_string(MPI_Info info,
                      const char key[],
                      int *buflen,
                      char value[],
                      int *flag)
...
static int
PyMPI_Info_create_env(int argc,
                      char *argv[],
                      MPI_Info *info)
{
  (void)argc; (void)argv;
...
static int
PyMPI_Type_contiguous_c(MPI_Count count,
                        MPI_Datatype oldtype,
                        MPI_Datatype *newtype)
{
  int ierr; int c;
...
static int
PyMPI_Type_vector_c(MPI_Count count,
...
static int
PyMPI_Type_create_hvector_c(MPI_Count count,
                            MPI_Count blocklength,
                            MPI_Count stride,
                            MPI_Datatype oldtype,
                            MPI_Datatype *newtype)
...
static int
PyMPI_Type_indexed_c(MPI_Count count,
                     ...
                     MPI_Datatype *newtype)
{
  ...
  PyMPICastValue(int, c, MPI_Count, count);
  PyMPICastArray(int, b, MPI_Count, array_of_blocklengths,  count);
  PyMPICastArray(int, d, MPI_Count, array_of_displacements, count);
...
static int
PyMPI_Type_create_hindexed_c(MPI_Count count,
                             const MPI_Count array_of_blocklengths[],
                             const MPI_Count array_of_displacements[],
                             MPI_Datatype oldtype,
                             MPI_Datatype *newtype)
{
  ...
  PyMPICastValue(int, c, MPI_Count, count);
  PyMPICastArray(int, b, MPI_Count, array_of_blocklengths,  count);
  PyMPICastArray(MPI_Aint, d, MPI_Count, array_of_displacements, count);
...
static int
PyMPI_Type_create_indexed_block_c(MPI_Count count,
                                  MPI_Count blocklength,
                                  const MPI_Count array_of_displacements[],
                                  MPI_Datatype oldtype,
                                  MPI_Datatype *newtype)
...
static int
PyMPI_Type_create_hindexed_block_c(MPI_Count count,
                                   MPI_Count blocklength,
                                   const MPI_Count array_of_displacements[],
                                   MPI_Datatype oldtype,
                                   MPI_Datatype *newtype)
...
static int
PyMPI_Type_create_struct_c(MPI_Count count,
                           const MPI_Count array_of_blocklengths[],
                           const MPI_Count array_of_displacements[],
...
{
  int ierr; int c, *b = NULL; MPI_Aint *d = NULL;
  MPI_Datatype *t = (MPI_Datatype *) array_of_types;
  PyMPICastValue(int,      c, MPI_Count, count);
  PyMPICastArray(int,      b, MPI_Count, array_of_blocklengths,  count);
  PyMPICastArray(MPI_Aint, d, MPI_Count, array_of_displacements, count);
...
static int
PyMPI_Type_create_subarray_c(int ndims,
...

{
  ...
  PyMPICastArray(int, N, MPI_Count, array_of_sizes,    ndims);
  PyMPICastArray(int, n, MPI_Count, array_of_subsizes, ndims);
  PyMPICastArray(int, s, MPI_Count, array_of_starts,   ndims);
...
static int
PyMPI_Type_create_darray_c(int size, int rank, int ndims,
...
{
  int ierr; int *g = NULL;
  PyMPICastArray(int, g, MPI_Count, array_of_gsizes, ndims);
...
static int
PyMPI_Type_create_resized_c(MPI_Datatype oldtype,
                            MPI_Count lb,
                            MPI_Count extent,
                            MPI_Datatype *newtype)
{
...
static int
PyMPI_Type_get_envelope_c(MPI_Datatype datatype,
...
static int
PyMPI_Type_get_contents_c(MPI_Datatype datatype,
...
static int
PyMPI_Unpack_c(const void *inbuf,
               MPI_Count insize,
               MPI_Count *position,
               void *outbuf,
               MPI_Count outcount,
...
static int
PyMPI_Pack_size_c(MPI_Count count,
                  MPI_Datatype datatype,
                  MPI_Comm comm,
                  MPI_Count *size)
{
...
static int
PyMPI_Pack_external_c(const char datarep[],
                      const void *inbuf,
                      MPI_Count incount,
                      MPI_Datatype datatype,
                      void *outbuf,
...
static int
PyMPI_Unpack_external_c(const char datarep[],
                        const void *inbuf,
                        MPI_Count insize,
                        MPI_Count *position,
                        void *outbuf,
...
static int
PyMPI_Pack_external_size_c(const char datarep[],
                           MPI_Count count,
                           MPI_Datatype datatype,
                           MPI_Count *size)
{
