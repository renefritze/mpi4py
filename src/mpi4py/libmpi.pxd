...
cdef import from "mpi.h" nogil:
    ...
    ctypedef int MPI_Datarep_extent_function_c(MPI_Datatype,MPI_Count*,void*)
    MPI_Datarep_conversion_function_c* MPI_CONVERSION_FN_NULL_C #:= 0
    int MPI_Register_datarep_c(char[], MPI_Datarep_conversion_function_c*, MPI_Datarep_conversion_function_c*, MPI_Datarep_extent_function_c*, void*)
